...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        ## there are no legal actions, which is the case at the terminal state, you should return a value of 0.0
        if len(actions) == 0:
            return 0.0
        maxValue = float("-inf")
        ## Look for max value
    ...
    def computeActionFromQValues(self, state):
        ...
        "*** YOUR CODE HERE ***"
        actions = self.getLegalActions(state)
        ## there are no legal actions, which is the case at the terminal state, you should return NOne
        if len(actions) == 0:
            return None
        maxValue = float("-inf")
        stateAction = ""
    ...
    def getAction(self, state):
        ...
        ## using flipcoin to get the acttion or random action
